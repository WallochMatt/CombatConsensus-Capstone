  ...
  const [fighters, setFighters] = useState([]);
    ...
    useEffect(() => {
      async function fetchEvents(){
        try {
            let response = await axios.get("http://52.15.152.115:8000/events/");
            // let response = await axios.get("http://52.15.152.115:8000/events/");
      ...
      const fetchMatches = async () => {
        try {
            let response = await axios.get("http://52.15.152.115:8000/matches/");
      ...
      const fetchFighters = async () => {
        try{
            let  response = await axios.get('http://52.15.152.115:8000/fighters/');
